...
const serviceCategories = [
 ...
 title: 'Deep Cleaning / Borongan', text: 'Pembersihan menyeluruh skala besar untuk hasil higienis maksimal. Layanan pembersihan total secara mendetail ke sudut yang jarang tersentuh. Ideal untuk kerak kamar mandi menahun, pasca-renovasi, pindahan rumah, hingga persiapan acara besar.' },
     ...
     { icon: () => <img src="/kosicon.png" alt="Kos" style={{ width: '50px', height: '50px', objectFit: 'contain' }} />,  title: 'Paket Kos (Pindahan / Serah Terima)',text: 'Solusi praktis dan hemat khusus anak kos dan pemilik persewaan. Layanan kilat untuk membersihkan kamar kos secara total. Cocok bagi penghuni baru yang ingin kamarnya steril, maupun penghuni lama yang akan pindah (checkout) agar serah terima kunci berjalan lancar.' },
    ],
  },
  {
    icon: () => <img src="/perawatanfurnituricon.png" alt="Perawatan Furnitur" style={{ width: '50px', height: '50px', objectFit: 'contain' }} />,
    title: 'Perawatan Furnitur & Estetik',
    items: [
      { icon: () => <img src="/laundrysofaicon.png" alt="Laundry Sofa" style={{ width: '50px', height: '50px', objectFit: 'contain' }} />,
  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="section area-section" id="area" ref={areaRef}><div className="section-heading" data-num="03" data-reveal><p className="eyebrow dark">JANGKAUAN KAMI</p><h2>Area Layanan Kami</h2><div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', color: '#666', lineHeight: '1.6' }}>
