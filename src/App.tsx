  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="section about-section" id="tentang" ref={aboutRef}><div className="about-image-wrap" data-reveal><img className="about-image" src="/IMG-20260908-WA0012.jpg" alt="Tentang Rencang Resik" /></div></section>
